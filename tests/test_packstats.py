...
class TestPackStats(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.copy_url = "http://ftp.uk.debian.org/debian/dists/stable/main/"
    ...
    def test_lists_architectures(self):
        ...
        result = get_content_files_list(self.copy_url)
    ...
    def test_get_content_index_file_url(self):
        ...
        urls = get_contents_file_urls(copy_url=self.copy_url, arch=self.architecture)
    ...
    def test_downloads_content_file(self):
        ...
        urls = get_contents_file_urls(self.architecture, self.copy_url)
    ...
    def test_gets_package_data_from_contents(self):
        ...
        urls = get_contents_file_urls(self.architecture, self.copy_url, include_udeb=True)
        with tempfile.TemporaryDirectory() as temp_directory:
